...
class GuiColorPicker
{
  ...
  public void render ()
  {
    ...
    if( mousePressed && mouseX >= x && mouseX < x + w && mouseY >= y && mouseY < y + h )
    {
      ...
      this.red = 0x00FF0000 & pixelColor;
      this.green = 0x0000FF00 & pixelColor;
      this.blue = 0x000000FF & pixelColor;
...
//a class which makes color organization for communicating with neo pixels easier.
class neoColor{
