...
name_handler(oDesign,[a1,b1,airboxhalflength],'mm',['a1','b1','airboxhalflength',''])
name_handler(oDesign,[alpha,beta,theta,gamma],'deg',['alpha','beta','theta1','gamma',''])
...
horizontal_move = [0, "2*a1*cos(beta)", 0]     ##this only works for flat state

#horizontal_move = [0, "2*a1", 0]

#duplicate_along_line(oDesign, vertical_move, "mm", "Quadrant_1,airbox_1",2)

duplicate_quadrants=duplicate_along_line(oDesign, horizontal_move, "mm", "Quadrant_1",4)
duplicate_airboxes=duplicate_along_line(oDesign, horizontal_move, "mm", "airbox_1",4)
...
# unite(oDesign,duplicate_airboxes)
